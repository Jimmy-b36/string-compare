...
class Calculator
{
    ...
    // ------------- ADDED BY ME -------------
    public function counter(string $old, string $new, $isDouble = true)
    {
        ...
        if ($isDouble === true) {
            ...
            return array("KwOriginal" => $countDoubleOld, "KwNew" => $countDoubleNew);
        }

        $countSingleOld = array_count_values($old);
        $countSingleNew = array_count_values($new);
        return array("KwOriginal" => $countSingleOld, "KwNew" => $countSingleNew);
    ...
    public function diff(string $old, string $new): array
    {
        ...
        // ------ EDITED to return two strings instead of one array ------
        return [
            'old' => $oldString,
            'new' => $newString
        ];
